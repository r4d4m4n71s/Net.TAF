...
public class UiTestConfiguration : TestConfiguration, IUiTestConfiguration
{
    ...
    public UiTestConfiguration(IDictionary<string, object> values, string id) : 
        base(values, id) => InitAttr();
    ...
    public UiTestConfiguration(string fromJsonDic, string id) 
        : base(fromJsonDic, id) => InitAttr();
